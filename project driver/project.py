...
bg = PhotoImage(file = r"D:\DRiver drousiness\project driver\back2.png")
...
predictor = dlib.shape_predictor(r"D:\DRiver drousiness\project driver\shape_predictor_68_face_landmarks.dat")
# This model is used to detect the facial landmarks on the detected faces.
...
def main():
	cap = cv2.VideoCapture(r"D:\DRiver drousiness\project driver\preview.mp4")
	sleep = 0
	drowsy = 0
	active = 0
	status=""
		...
		for face in faces:
			...
			if(left_blink==0 or right_blink==0):
				...
				if(sleep>6):
						...
						color = (255,0,0)
						mixer.init()
						mixer.music.load("D:/DRiver drousiness/project driver/sound_files/alarm1.wav")
				...
				if(drowsy>6):
						...
						color = (0,0,255)
						mixer.init()
						mixer.music.load("D:/DRiver drousiness/project driver/sound_files/warning_yawn.mpeg")
						mixer.music.play()
						while mixer.music.get_busy():  # wait for music to finish playing
							time.sleep(1)
			else:
		...
		for face in faces:
			...
			if(left_blink==0 or right_blink==0):
				...
				if(drowsy>6):
						...
						color = (0,0,255)
						mixer.init()
						mixer.music.load("D:/DRiver drousiness/project driver/sound_files/alarm2.wav")
						mixer.music.play()
						while mixer.music.get_busy():  # wait for music to finish playing
							time.sleep(1)
			else:
